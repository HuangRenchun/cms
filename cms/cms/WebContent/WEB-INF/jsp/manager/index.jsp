...
<div class="main">
	<div id="top">
    	<div class="top">
            ...
            <div class="t_sign">
            	<span>你好，管理员</span><a href="#" class="t_exit">退出</a><br/>
            	<span>跳到前台</span><a href="../toIndex.action">前台管理</a>
            </div>
        </div>
    </div>
    <div id="cont">
    	<div class="centent">
        	<div class="left">
            	<ul class="baseUI">
                    ...
                    <li url="toAddMedicine.action"><a href="#"><em class="base_basicset"></em><span>药品入库</span></a></li>
                    <li url="toMedicineManager.action"><a href="#"><em class="base_sys"></em><span>库存药品管理</span></a></li>
                </ul>
            </div>
            <!--内容页面-->
